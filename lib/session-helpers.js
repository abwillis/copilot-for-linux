...
function createSessionHelpers(deps = {}) {
  const {
    ...
    fs, path,
    getAppConfig, getCopilotPartition, getCopilotUrl,
    getConfigFilePath, getLogFilePath,
    getMainWindow, safeShowError,
  } = deps;
  ...
  function _partition() { return (typeof getCopilotPartition === 'function') ? getCopilotPartition() : ''; }
  function _copilotUrl() { return (typeof getCopilotUrl === 'function') ? getCopilotUrl() : ''; }
  function _mainWindow() { return (typeof getMainWindow === 'function') ? getMainWindow() : null; }
...
function showApplicationHelp() {
  ...
  return {
    getRuntimeInfo,
    getCopilotSession,
    getActiveCopilotWindow,
    getActiveCopilotWebContents,
    reloadCopilot,
    clearCopilotCache,
